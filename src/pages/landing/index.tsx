    ...
    <div>
        ...
        <section>
            <div className="flex items-center justify-between gap-5 max-w-7xl px-16 py-32 mx-auto">
                <div className="w-3/5">
                        <h1 className="w-3/4 text-5xl font-medium tracking-tight">
                    ...
                    <div className="w-3/4 my-8 mx-5">
                        <div className="align-items-center flex my-2">
                            <div className="rounded-full w-2 h-2 bg-primary my-auto mx-3 relative"></div>
                            <h1>New projects can be found on the projects page.</h1>
                        </div>

                        <div className="align-items-center flex my-2">
                            <div className="rounded-full w-2 h-2 bg-primary my-auto mx-3 "></div>
                        ...
                        <div className="align-items-center flex my-2">
                            <div className="rounded-full w-2 h-2 bg-primary my-auto mx-3 flex-wrap"></div>
                            <h1>I do not make any money from this website.</h1>
                        </div>
                    </div>
                    <div className="flex items-center gap-5">
                            <button onClick={() => { navigate('/projects'); }} className="h-12 px-6 bg-primary rounded-md font-semibold group focus:ring-4 ring-primary ring-opacity-50 transition-all flex items-center text-white hover:bg-transparent hover:text-gray-800 border-2 border-primary">
                            <h1>View Projects</h1>
                            ...
                            <button onClick={() => { window.location.href.endsWith('#blog') ? window.location.href += '' : window.location.href += '#blog'; }} className="h-12 px-6 border-2 border-primary rounded-md font-semibold group focus:ring-4 ring-primary ring-opacity-50 transition-all flex items-center hover:bg-primary hover:text-white">
                            <h1>Read Blog</h1>
                        </button>
                    </div>
                </div>
        ...
        <section id="blog" className="py-5">
            <div className="items-center justify-between gap-5 max-w-7xl px-16 mx-auto">
                <h1 className="font-semibold my-2 text-primary">UPDATES</h1>
                <div className="grid grid-cols-3 gap-5 my-4">
                    <div className=" col-span-1 duration-150 border-t border-gray-300">
                        <div className="h-0 "></div>
                            <div className="mt-8 mb-2">
                                <h1 className="text-sm font-semibold text-gray-400">Feb 13, 2022</h1>
                                <h1 className="text-3xl font-medium text-gray-800">A New Redesign for Paridax.xyz</h1>
                            </div>
                            <p className="text-sm text-gray-600 h-24">I think this has been pretty long overdue so here we go. I have redesigned the page from the ground up using ReactJS. Planned updates: adding more pages and site functionality, as well as blog pages. Also dark mode please my eyes.</p>

                            <button onClick={() => { /* navigate('/blog/a-new-redesign-for-paridax-xyz'); */ }} className="text-md py-3 rounded-md font-semibold group transition-all flex items-center  hover:brightness-120 hover:text-primary focus:text-primary w-auto">
